    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (resultSet.next()) {
                observableList.add(new HangHoa_Module(resultSet.getInt(1),resultSet.getInt(2), resultSet.getString(3), resultSet.getString(4),resultSet.getString(5), resultSet.getDouble(6), resultSet.getDouble(7), resultSet.getDouble(8), resultSet.getDouble(9)));
            }
